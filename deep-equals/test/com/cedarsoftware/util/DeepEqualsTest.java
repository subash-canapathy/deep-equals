...
{    
    ...
    {
        Pet p1 = new Pet();
        p1.name = new String("Eddie");
        p1.type = new String("Terrier");
        
        Pet p2 = new Pet();
        p2.name = new String("Eddie");
        p2.type = new String("Terrier");
        
        Pet p3 = new Pet();
        p3.name = new String("Penny");
        p3.type = new String("Chihuahua");
        
        Pet p4 = new Pet();
        p4.name = new String("Penny");
        p4.type = new String("Chihuahua");
